...
import {isValidIncome, errorFunction, calculateTax, isValidIncome2} from "./taxCalculator.js" //.js because when node executes it, it sees a .js code
